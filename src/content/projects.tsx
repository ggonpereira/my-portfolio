...
export const projectsEn = [
  ...
  },
  {
    ...
    techs: ['ReactJS', 'TypeScript', 'Storybook', 'Tailwind CSS', 'Jest'],
  },
  {
    name: 'Techy Feed',
    description:
...
export const projectsPt = [
  {
    name: 'My Portfolio',
    description:
      'Portfolio criado para expor meu trabalho de forma mais interativa e completa | ReactJS, NextJS, Componentes estilizados, TypeScript',
    image: project1,
    url: 'https://github.com/ggonpereira/my-portfolio',
    techs: ['ReactJS', 'NextJS', 'Styled Components', 'TypeScript'],
  },
  {
    name: 'EasyOrder App Mobile',
    description:
      'Aplicativo móvel para o aplicativo EasyOrder | Componentes React Native, TypeScript e Styled | Desenvolvido seguindo as lições do JStack',
    image: project2,
    url: 'https://github.com/ggonpereira/easyorder-app-mobile',
    techs: ['React Native', 'Styled Components', 'TypeScript'],
  },
  {
    name: 'EasyOrder App Dashboard',
    description:
      'Dashboard para o aplicativo EasyOrder | ReactJS, TypeScript e componentes de estilo | Desenvolvido seguindo as lições do JStack',
    image: project3,
    url: 'https://github.com/ggonpereira/easyorder-app-dashboard',
    techs: ['ReactJS', 'Styled Components', 'TypeScript'],
  },
  {
    name: 'EasyOrder App API',
    description:
      'API para o aplicativo EasyOrder | MongoDB, NodeJS, Express e Multer | Desenvolvido seguindo as lições do JStack',
    image: project4,
    url: 'https://github.com/ggonpereira/easyorder-app-api',
    techs: ['Node.JS', 'MongoDB', 'Express'],
  },
  {
    name: 'Working Lab Design System',
    description:
      'Design System desenvolvido usando TypeScript, React, Radix, Storybook, Tailwind CSS e Jest',
    image: project5,
    url: 'https://github.com/ggonpereira/working-lab-design-system',
    techs: ['ReactJS', 'TypeScript', 'Storybook', 'Tailwind CSS', 'Jest'],
  },
  {
    name: 'Techy Feed',
    description:
      'Projeto contemplando os fundamentos do React. Desenvolvido usando Typescript e ReactJS',
    image: project6,
    url: 'https://github.com/ggonpereira/techy-feed',
    techs: ['ReactJS', 'TypeScript', 'Styled Components', 'React Hook Form'],
  },
  {
    name: 'Studies App',
    description:
      'Um projeto criado usando TypeScript, Styled Components, React e testes usando React Testing Library seguindo as aulas do Alura. Neste aplicativo você poderá adicionar pendências e adicionar um cronômetro para concluir a tarefa!',
    image: project7,
    url: 'https://github.com/ggonpereira/studies-app',
    techs: [
      'ReactJS',
  ...
  },
  {
    name: 'Posts Feed',
    description:
      'Um projeto front-end criado usando React e Styled Components. Aplicativo simples onde você pode postar algo e ver todos os posts no feed.',
    image: project8,
    url: 'https://github.com/ggonpereira/posts-feed-project',
    techs: ['ReactJS', 'TypeScript', 'Styled Components'],
  },
...
export const noTechsSelectedStateEn = `/**
  *
  * SELECT A TECH ON THE LEFT SIDEBAR TO VIEW INFORMATION
  * 
**/`

export const noTechsSelectedStatePt = `/**
  *
  * SELECIONE UMA TECNOLOGIA NO MENU LATERAL
  * ESQUERDO PARA VER INFORMAÇÕES
  * 
**/`

export const noProjectsFoundEn = `/**
  *
...
export const noProjectsFoundPt = `/**
  *
  * NÃO HÁ PROJETOS CRIADOS USANDO ESSA TECNOLOGIA AINDA,
  * SELECIONE ALGUMA OUTRA NO MENU LATERAL ESQUEDO
  * 
**/`
